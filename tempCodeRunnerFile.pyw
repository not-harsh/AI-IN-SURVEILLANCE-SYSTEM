...
#----------register Label----------
label_register = Label(root, text="REGISTER", bg="black", fg="red", font="georgia 30 bold").place(x=650,y=80)


#----------firstname entry----------
label_firstname = Label(root, text="First Name", bg="black", fg="white", font="georgia 15 bold").place(x=180,y=200)
firstname = StringVar()
entry_firstname = Entry(root, textvariable=firstname, font="verdana 13", bg="lightgrey").place(x=180,y=230,width=350,height=35)


#----------lastname entry----------
label_lastname = Label(root, text="Last Name", bg="black", fg="white", font="georgia 15 bold").place(x=990,y=200)
lastname = StringVar()
...
label_contact = Label(root, text="Contact Number", bg="black", fg="white", font="georgia 15 bold").place(x=180,y=300)
contact = StringVar()
entry_contact = Entry(root, textvariable=contact, font="verdana 13", bg="lightgrey").place(x=180,y=330,width=350,height=35)


#----------email entry----------
label_email = Label(root, text="Email", bg="black", fg="white", font="georgia 15 bold").place(x=990,y=300)
email = StringVar()
...
label_question = Label(root, text="Security Question", bg="black", fg="white", font="georgia 15 bold").place(x=180,y=400)
question = StringVar()
...
#----------answer entry----------
label_answer = Label(root, text="Answer", bg="black", fg="white", font="georgia 15 bold").place(x=990,y=400)
answer = StringVar()
entry_answer = Entry(root, textvariable=answer, font="verdana 13", bg="lightgrey").place(x=990,y=430,width=350,height=35)


#----------password entry----------
label_password = Label(root, text="Password", bg="black", fg="white", font="georgia 15 bold").place(x=180,y=500)
password = StringVar()
...
label_confirmpass = Label(root, text="Confirm Password", bg="black", fg="white", font="georgia 15 bold").place(x=990,y=500)
...
#----------T&C checkbox----------
check = IntVar()
button_check = Checkbutton(root, text="I Agree The Terms & Conditions", variable=check, onvalue=1, offvalue=0, bg="black", fg="red", font="georgia 13 bold").place(x=180,y=580)


#----------register button----------
button_register = Button(root, command=register_data, text="Register",cursor="hand2", width=20, height=1, bg="red", bd=0, fg="white", font="georgia 15 bold").place(x=690,y=680,width=180,height=40)


#----------login button----------
button_login = Button(root, command=redirect_login, text="Log In",cursor="hand2", bg="black", bd=0, fg="red", font="georgia 15").place(x=1300,y=720)
